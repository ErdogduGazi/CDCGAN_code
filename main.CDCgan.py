import os
import numpy as np
from tensorflow.keras.layers import Input, Dense, Reshape, Flatten, Dropout, BatchNormalization, Activation, LeakyReLU, UpSampling2D, Conv2D, Embedding, multiply, Concatenate, ZeroPadding2D
...
dex_image_folder = r"D:\\Mezuniyet Projesi\\datasets\\samples\\malware\\malwaremanifestpng"
...
def train(epochs, batch_size=8, save_interval=20, num_images_to_save=64):
    ...
    for epoch in range(epochs):
        ...
        if epoch % save_interval == 0:
            ...
            print(f"Görüntüler epoch {epoch} 'da kaydedildi")

def save_imgs(epoch, generator, num_images_to_save):
    save_dir = r"D:\\Mezuniyet Projesi\\datasets\\samples\\malware\\CDCGANmalware\\CDCgan_malwmanifestdeneme2"
